var game = {
    ...
    "onload": function() {
        if (!me.video.init("screen", me.video.CANVAS, 900, 600, true, 'auto')) {
            alert(_("Your browser does not support HTML5 canvas."));
            return;
        }
...
game.resources = [
    ...
    {name: "logo", type:"image", src: _("data/img/logo.png")},
    {name: "ground", type:"image", src: "data/img/ground.png"},
    {name: "gameover", type:"image", src: _("data/img/gameover.png")},
    {name: "gameoverbg", type:"image", src: "data/img/gameoverbg.png"},
    {name: "hit", type:"image", src: "data/img/hit.png"},
    {name: "getready", type:"image", src: _("data/img/getready.png")},
    {name: "new", type:"image", src: _("data/img/new.png")},
    {name: "share", type:"image", src: _("data/img/share.png")},
    {name: "tweet", type:"image", src: _("data/img/tweet.png")},
    // sounds
...
game.HUD.ScoreItem = me.Renderable.extend({
    ...
    init: function(x, y) {
        ...
        this.stepsFont = new me.Font('WawatiSC-Regular', 100, '#000', 'center');
...
var Share = me.GUI_Object.extend({
    ...
    onClick: function(event) {
        var shareText = _('Just made') + ' ' + game.data.steps + ' ' + _('steps on Clumsy Bird! Can you beat me? Try online here!');
        var url = 'http://ellisonleao.github.io/clumsy-bird/';
        FB.ui(
            {
             method: 'feed',
             name: _('My Clumsy Bird Score!'),
             caption: _("Share to your friends"),
             description: (
                    shareText
             ),
             link: url,
    ...
    onResetEvent: function() {
        ...
        me.game.world.addChild(new (me.Renderable.extend ({
            ...
            init: function() {
                ...
                this.text = me.device.touch ? 'Tap to start' : _('PRESS SPACE OR CLICK LEFT MOUSE BUTTON TO START') + '\n' + '\t\t\t\t\t\t\t\t\t\t\t' + _('PRESS "M" TO MUTE SOUND');
                this.font = new me.Font('Wawati SC', 25, '#000');
            },
            draw: function (renderer) {
                var context = renderer.getContext();
    ...
    onResetEvent: function() {
        ...
        this.dialog = new (me.Renderable.extend({
            ...
            init: function() {
                ...
                // renderable
                this._super(me.Renderable, 'init', [0, 0, 100, 100]);
                this.font = new me.Font('Wawati SC', 50, 'black', 'left');
                this.steps = _('Steps:') + ' ' + game.data.steps.toString();
                this.topSteps= _('Higher Step:') + ' ' + me.save.topSteps.toString();
            },
